declare var json_merge_allow_json_without_script_tag;
export interface JSONMergeProperties {
...
(function () {
    ...
    function initJSONMerge(polymerMixin : any) {
         ...
         */
        class JSONMerge extends polymerMixin(HTMLElement) implements JSONMergeProperties {
